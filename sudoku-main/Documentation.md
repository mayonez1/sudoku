...
If you want to remove all object files/binaries you can enetr the command "make -f make.mak clean" (note: this will remove all files with the .o extension in that folder).</p>
